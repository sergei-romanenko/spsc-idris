...
testAddAB = testBS
  ...
  "(gAdd1(a,b), gAdd1(Z,b) = b;gAdd1(S(v1),b) = S(gAdd1(v1,b));)"
...
testAddAdd = testBS
  ...
  "(gAdd1(a,b,c), gAdd2(Z,c) = c;gAdd2(S(v2),c) = S(gAdd2(v2,c));gAdd1(Z,b,c) = gAdd2(b,c);gAdd1(S(v1),b,c) = S(gAdd1(v1,b,c));)"
...
testAddAccAB = testBS
  ...
  "(gAddAcc1(a,b), gAddAcc1(Z,b) = b;gAddAcc1(S(v1),b) = gAddAcc1(v1,S(b));)"
...
testAdvAddAA = testAS
  ...
  "(gAdd1(a,a), gAdd1(Z,v4) = v4;gAdd1(S(v5),v4) = S(gAdd1(v5,v4));)"
...
testAdvAddAccAA = testAS
  ...
  "(gAddAcc1(a,a), gAddAcc1(Z,v4) = v4;gAddAcc1(S(v5),v4) = gAddAcc1(v5,S(v4));)"
...
testAdvAddAccAddAcc = testAS
  ...
  "(gAddAcc1(a,b,c), gAddAcc2(Z,c) = c;gAddAcc2(S(v2),c) = gAddAcc2(v2,S(c));gAddAcc1(Z,b,c) = gAddAcc2(b,c);gAddAcc1(S(v1),b,c) = gAddAcc1(v1,S(b),c);)"
